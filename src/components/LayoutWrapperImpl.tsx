...
export default function LayoutWrapperImpl({ children }: { children: ReactNode }) {
  ...
  // Используем bg-white как fallback, но если bgImage определено, используем bg-transparent
