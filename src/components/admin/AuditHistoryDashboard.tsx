...
const AuditHistoryDashboard = () => {
  ...
  return (
    <div className="p-4 h-full flex flex-col min-h-0">
      ...
      {loading && (
        <div className="py-4 text-center text-gray-500 flex-shrink-0">
          Загрузка истории действий...
        </div>
      )}

      {error && (
        <div className="bg-red-50 border border-red-200 rounded-md p-4 mb-4 flex-shrink-0">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50 sticky top-0 z-10">
                <tr>
                  ...
                  <th scope="col" className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[150px]">
                    Объект
                  </th>
