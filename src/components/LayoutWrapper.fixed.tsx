...
export default function LayoutWrapper({ children }: { children: ReactNode }) {
  ...
  // Добавляем suppressHydrationWarning для предотвращения ошибок гидрации
  const effectiveMainClass = isClient && bgImage ? 'flex-grow bg-transparent' : 'flex-grow bg-white';
  ...
  return (
    <div className="min-h-screen flex flex-col pb-16 md:pb-0">
      ...
      <HeaderWrapper />
      <main className={effectiveMainClass} suppressHydrationWarning={true}>
        {children}
      </main>
      <Footer />
      <MobileBottomNav />
