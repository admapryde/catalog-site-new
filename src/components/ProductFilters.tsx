...
export default function ProductFilters({
  ...
  return (
    <div className={`fixed inset-y-0 left-0 z-60 w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
